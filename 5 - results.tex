...
\subsubsection*{Naturally occurring cases of the alternate hypothesis support the efficiency of the methods}
...
\subsubsection*{The \textit{D. melanogaster} genome has genome-wide elevation of mutation disequilibrium when compared to its sister taxa, \textit{D. simulans}}
