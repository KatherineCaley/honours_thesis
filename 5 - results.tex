...
\subsection*{Initialisation of models did not affect parameter estimates}
...
Applying both tests to their respective null distributions indicated that both tests are consistent with theoretical expectations, presented in Figure \ref{fig:eop}. This is illustrated by Quantile-Quantile plots comparing the distribution of p-values to the uniform distribution for alignments of length 300 (fig. \ref{fig:eop}a) and 3,000 (fig. \ref{fig:eop}b).  This indicates that in application of both test, it is suitable to assume the statistic is $\chi^2_{df}$ distributed and in turn, obtain the p-value simply from analytical distribution. 

\section*{Validation of method behaviour with empirical application}

In this section to in order to .... I did ... 
