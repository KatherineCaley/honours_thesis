...
\newglossaryentry{Psuedo-Autosomal Region}
{
...
\newglossaryentry{Substitution model}
{
...
\newglossaryentry{nested}
{
        name=Nested,
        text=nested,
        description={One `null’ model is considered nested in another if it can be specified simply by imposing restrictions on the parameters of the `alternate’ model}
}
